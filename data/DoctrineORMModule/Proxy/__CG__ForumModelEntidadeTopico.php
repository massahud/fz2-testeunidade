...
namespace DoctrineORMModule\Proxy\__CG__\Forum\Model\Entidade;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Topico extends \Forum\Model\Entidade\Topico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Forum\\Model\\Entidade\\Topico' . "\0" . 'id', '' . "\0" . 'Forum\\Model\\Entidade\\Topico' . "\0" . 'forum', '' . "\0" . 'Forum\\Model\\Entidade\\Topico' . "\0" . 'usuario', '' . "\0" . 'Forum\\Model\\Entidade\\Topico' . "\0" . 'titulo', '' . "\0" . 'Forum\\Model\\Entidade\\Topico' . "\0" . 'texto', '' . "\0" . 'Forum\\Model\\Entidade\\Topico' . "\0" . 'comentarios', '' . "\0" . 'Forum\\Model\\Entidade\\Topico' . "\0" . 'dataCriacao');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Topico $proxy) {
